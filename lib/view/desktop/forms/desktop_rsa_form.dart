...
class _DesktopRsaFormState extends State<DesktopRsaForm> {
  ...
  Future<bool> _applyCriptography() async {
    ...
    var secret = await context
        .read<CryptoService>()
        .cryptograph(message: cleanTextController.text, publicKey: publicKey);
    if (secret != null) {
  ...
  _handleDecrypt() async {
    ...
    if (errors != null) {
      ...
      if (cleanText != null) {
        ...
        cleanTextController.text =
            "ERRO! Esta chave não foi capaz de descriptografar o texto";
      }
    }
  }
                            ...
                            children: [
                              ...
                              TextFormField(
                                ...
                                decoration: const InputDecoration(
                                    border: OutlineInputBorder(),
                                    hintText:
                                        "Carregue ou gere uma chave publica",
                                    contentPadding: EdgeInsets.symmetric(
                                        vertical: 12, horizontal: 8)),
